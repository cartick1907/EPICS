...
/* Generated from ../O.Common/helloWorld.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_register_func_testProc;
...
int helloWorld_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/kartik/Apps/epics/helloWorld";
...
/* helloWorld_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"helloWorld_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    helloWorld_registerRecordDeviceDriver(*iocshPpdbbase);
}
